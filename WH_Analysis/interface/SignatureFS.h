...
class SignatureFS
{
	public:
		...
		//! Return the string description giving the EFS enum final state
		static const char * GetFSID(const unsigned int & efs );
		inline static const char * GetFSID(const  EFS & efs ) { return GetFSID( (unsigned int)efs ); }
